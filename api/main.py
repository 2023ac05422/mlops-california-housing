...
PRED_LATENCY = Histogram("pred_request_latency_seconds", "Latency for prediction requests")
...
def predict(rec: HousingRecord):
    ...
    start = time.time()
    try:
        X = [[rec.MedInc, rec.HouseAge, rec.AveRooms, rec.AveBedrms,
              rec.Population, rec.AveOccup, rec.Latitude, rec.Longitude]]
